...
public class PromptBuilder_ENG {
    ...
    public static String build(String questionSi) {
        ...
        String rules = "ඔබ ශ්‍රී ලංකා නීති පිළිබඳ English legal assistant එකකි.\n" +
                "පහත JSON schema එකට අනුකූලව JSON පමණක් පිළිතුරු දෙන්න. Markdown/අමතර පෙළ/කේත වළකු.\n" +
                "සියලුම අගයන් English වලින් දෙන්න. දන්නා නොමිලිත තොරතුරු තිබේ නම් \"තහවුරු කළ යුතුයි\" ලෙස සඳහන් කරන්න.\n" +
